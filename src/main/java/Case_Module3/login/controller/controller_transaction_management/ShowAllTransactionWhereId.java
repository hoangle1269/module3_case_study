...
@WebServlet(name = "showAllTransactionWhereId", urlPatterns = "/showAllTransactionWhereId")
public class ShowAllTransactionWhereId extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        listTransaction = TransactionDao.showTransactionWhereIdWallet(idWallet);
